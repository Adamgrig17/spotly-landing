      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Η πλατφόρμα Spotly (parkspotly.gr) λειτουργεί από την εταιρεία με νόμιμη επωνυμία «SPOTLY PARKING MANAGEMENT ΕΤΕΡΟΡΡΥΘΜΗ ΕΤΑΙΡΕΙΑ» (Spotly Parking Management L.P.), διακριτικό τίτλο «SPOTLY», ΑΦΜ 803339090, αριθμό ΓΕΜΗ 194898201000 και έδρα την Αθήνα. Το Spotly λειτουργεί αποκλειστικά ως ενδιάμεσος (διαδικτυακή πλατφόρμα) που συνδέει άτομα που αναζητούν χώρο στάθμευσης ("Οδηγοί") με ιδιοκτήτες ή διαχειριστές χώρων στάθμευσης ("Hosts"). Το Spotly δεν κατέχει, δεν ενοικιάζει και δεν διαχειρίζεται τους χώρους στάθμευσης.
            </p>
          </section>
