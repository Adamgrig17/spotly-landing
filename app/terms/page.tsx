      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Η πλατφόρμα Spotly (parkspotly.gr) λειτουργεί από την εταιρεία με νόμιμη επωνυμία «SPOTLY PARKING MANAGEMENT ΕΤΕΡΟΡΡΥΘΜΗ ΕΤΑΙΡΕΙΑ» (SPOTLY PARKING MANAGEMENT L.P.), διακριτικό τίτλο «SPOTLY» και ΑΦΜ 803339090. Το Spotly λειτουργεί αποκλειστικά ως ενδιάμεσος (διαδικτυακή πλατφόρμα) που συνδέει άτομα που αναζητούν χώρο στάθμευσης ("Οδηγοί") με ιδιοκτήτες ή διαχειριστές χώρων στάθμευσης ("Hosts"). Το Spotly δεν κατέχει, δεν ενοικιάζει και δεν διαχειρίζεται τους χώρους στάθμευσης.
            </p>
          </section>
