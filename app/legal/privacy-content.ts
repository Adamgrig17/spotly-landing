...
export const privacyContent: Record<'el' | 'en', LegalDoc> = {
  el: {
    langLabel: 'Ελληνικά',
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          { label: 'Δεδομένα Επικοινωνίας & Χρήσης', text: 'Μηνύματα στο chat κράτησης μεταξύ Οδηγού και Host, κείμενα και φωτογραφίες καταχωρίσεων, στοιχεία προφίλ, αναφορές περιεχομένου ή χρηστών, αιτήματα υποστήριξης (συμπεριλαμβανομένων ερωτημάτων προς το Spot AI), καθώς και token ειδοποιήσεων της συσκευής σας (εφόσον αποδεχθείτε τις push ειδοποιήσεις).' },
        ],
      },
      {
      ...
      {
        title: '6. Περιεχόμενο χρηστών και αποδεκτή χρήση',
        paragraphs: [
          'Η εφαρμογή περιλαμβάνει chat μεταξύ χρηστών και καταχωρίσεις που δημιουργούν οι Hosts. Η Spotly εφαρμόζει πολιτική μηδενικής ανοχής σε προσβλητικό περιεχόμενο και σε καταχρηστική συμπεριφορά. Απαγορεύεται περιεχόμενο παράνομο, υβριστικό, απειλητικό, ρατσιστικό, σεξουαλικού περιεχομένου, παρενοχλητικό, καθώς και πλαστοπροσωπία, spam ή προσβολή δικαιωμάτων τρίτων, σε μηνύματα, καταχωρίσεις, φωτογραφίες και στοιχεία προφίλ.',
          'Κάθε χρήστης μπορεί να αναφέρει περιεχόμενο ή άλλον χρήστη μέσα από την εφαρμογή· οι αναφορές εξετάζονται εντός 24 ωρών. Μπορείτε να αποκλείσετε άλλον χρήστη. Περιεχόμενο που παραβιάζει τους Όρους Χρήσης αφαιρείται και οι λογαριασμοί που εμπλέκονται ενδέχεται να ανασταλούν ή να διαγραφούν οριστικά, χωρίς προειδοποίηση. Λεπτομέρειες στους Όρους Χρήσης.',
        ],
      },
    ],
    contactTitle: '7. Επικοινωνία',
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          { label: 'Communication & Usage Data', text: 'Booking chat messages between Driver and Host, listing text and photos, profile information, reports of content or users, support requests (including questions sent to Spot AI), and your device\'s notification token (if you accept push notifications).' },
        ],
      },
      {
      ...
      {
        title: '6. User content and acceptable use',
        paragraphs: [
          'The app includes user-to-user chat and Host-created listings. Spotly has a zero-tolerance policy for objectionable content and abusive behaviour. Illegal, abusive, threatening, racist, sexually explicit or harassing content, as well as impersonation, spam or infringement of third-party rights, is prohibited in messages, listings, photos and profile information.',
          'Any user may report content or another user from inside the app; reports are reviewed within 24 hours. You may block another user. Content that breaches the Terms of Use is removed, and accounts involved may be suspended or permanently deleted, without prior notice. See the Terms of Use for the full rules.',
        ],
      },
    ],
