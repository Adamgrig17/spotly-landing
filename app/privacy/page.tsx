        ...
        <div className="space-y-12 text-gray-300 leading-relaxed">
          ...
          <section>
            <p className="text-lg font-medium text-white mb-6">
              Η πλατφόρμα Spotly (parkspotly.gr) λειτουργεί από την εταιρεία με νόμιμη επωνυμία «SPOTLY PARKING MANAGEMENT L.P.», διακριτικό τίτλο «SPOTLY» και ΑΦΜ 803339090 (εφεξής "εμείς", "η Εταιρεία"). Σεβόμαστε τα προσωπικά σας δεδομένα και δεσμευόμαστε να τα προστατεύουμε σύμφωνα με τον Γενικό Κανονισμό για την Προστασία Δεδομένων (ΓΚΠΔ / GDPR).
            </p>
          </section>
