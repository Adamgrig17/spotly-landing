...
const translations = {
  el: {
    ...
    hero: {
      ...
      desc: "Η πρώτη και μοναδική πλατφόρμα που μετατρέπει τα κλειστά ιδιωτικά γκαράζ σε δικές σου θέσεις στάθμευσης, σε όλη την Ελλάδα. Κλείσε θέση εκ των προτέρων, άνοιξε την πόρτα με ένα πάτημα στο κινητό σου και ξέχασε το άγχος.",
      eyebrow: "Επαληθευμένες ιδιωτικές θέσεις",
    },
    how: {
      title1: "Η Μαγεία της",
      title2: "Απλότητας",
  ...
  en: {
    ...
    hero: {
      ...
      eyebrow: "Verified private parking spaces",
    },
    how: {
      title1: "The Magic of",
      title2: "Simplicity",
